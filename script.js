...
// =========================================================
const GAS_API_URL = 'https://script.google.com/macros/s/AKfycbxiHLl23IgGgPTDnuqtIkVQYFxbh7E0z_YHqi96T_y_38EwerYpe1bkZArPDdA62wMg/exec'; 
// =========================================================
...
async function loadQuizData(selectedSheetName = '全商２級クイズ') { 
    try {
